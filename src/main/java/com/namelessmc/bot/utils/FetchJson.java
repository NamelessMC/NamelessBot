...
public class FetchJson {
    ...
    public static JsonArray asArrayFromUrl(String url) { return asArrayFromUrl(url, true); }
    ...
    public static JsonArray asArrayFromUrl(String url, boolean showException) {
        ...
        try {
            ...
            if (responseCode == 404) {
                ...
                jsonResponse.add("responseCode: " + responseCode);
            } else {
                jsonResponse = new JsonParser().parse(response.toString()).getAsJsonArray();
            }
            return jsonResponse;
        } catch (Exception e) {
            if (showException) {
